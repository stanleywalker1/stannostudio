    ...
    <div name='mit' className='w-full h-full bg-[#0a192f] text-gray-300'>
        ...
        <div className='pt-20 pb-1 sm:text-center text-1xl'>
            ...
            <div className="max-w-[1000px] w-full flex justify-around pb-20">
                ...
                Hi! My name is Stanley. I’m passionate about interactive technologies and immersing myself around diverse cultures and people. I love exploring mediums for creative design with emerging and experimental technologies, both digital and physical. I’m a privileged to have experience in various ecosystems that I attribute to my creativity, including Shanghai, Tel Aviv, and New York City, with an additional 50+ countries explored. 

MIT Media Lab has always been a dream of mine since I discovered it as a child when learning Scratch and its roots with Professor Mitchel Resnick. This interested expanded through my time at NYU’s Interactive Media Arts Program in Shanghai and Interactive Telecommunications Program in New York City. Thank you in advance for your time and attention and I hope you enjoy the highlights of my work. 
                </p>
                </div>
                </div>
